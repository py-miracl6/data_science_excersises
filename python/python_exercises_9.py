...
st.markdown(
    ...
    "   - Метод **summation** - должен принимать на вход объект типа list и **возвращать сумму элементов**. Предусмотреть исключения **TRY-EXCEPT**, **при ошибке не должно НИЧЕГО возвращатся**\n"
