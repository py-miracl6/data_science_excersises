...
st.markdown(
    "- Создайте функцию и назовите ее **summation**. На вход она должна принимать два параметра **value_1** и **value_2** (может быть как тип int, так и float для каждого, подсказка Union[..,..])\n"
